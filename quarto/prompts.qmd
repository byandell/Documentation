...
How will you later remember how you used [Artificial Intelligence (AI)](../AI.md) to advance your projects? And how will you share your learning with others?
...
::: {.callout-note}
See Diana and Alan's evolved prompt versions in [prompts/powerpoint.md](../prompts/powerpoint.md).
:::
...
::: {.callout-tip}
### Refined Prompts
Check out [prompts/file_versions.md](../prompts/file_versions.md) for a streamlined, instruction-optimized version of this prompt.
:::
