...
[Docker](https://www.docker.com/) and [Guix](https://www.gnu.org/s/guix) ⚠️ are mechanisms for building and running isolated “containers” of software.
...
### [GNU Guix](https://www.gnu.org/s/guix) ⚠️
...
- [Making the Case for adopting GNU Guix for Linux package management (Malcom Cook)](https://github.com/malcook/sce) ⚠️
- [GNU Guix Reference Manual](https://www.gnu.org/software/guix/manual/) ⚠️
