...
offered these guiding principles at
...
- [Setup](#setup)
- [Basics of RStudio](#basics-of-rstudio)
- [R project](#r-project)
- [Scripts](#scripts)
- [R Environment and Closing out RStudio](#r-environment-and-closing-out-rstudio)
