...
This was an exciting mix of top-notch IT experts sharing learning and access state-of-the-art tools.
...
My notes on [Shiny](https://shiny.posit.co/) were organized in the
[geyser](https://github.com/byandell/geyser) repository
to help me consolidate my understanding of `Shiny` in `R` and `Python`.
